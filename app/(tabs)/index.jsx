...
const HomeScreen = () => {
  ...
  const loadData = async()=>{
    try {
      ...
      const transformedMeals = randomMeals.map((meal)=>MealAPI.transformMealData(meal))
            ...
            <View style={homeStyles.featuredImageContainer}>
              ...
              <View style={homeStyles.featuredOverlay}>
                <View style={homeStyles.featuredBadge}>
                  <Text style={homeStyles.featuredBadgeText}>Featured
                  </Text>
                </View>
        ...
        <View style={homeStyles.recipesSection}>
          ...
          {recipes.length>0 ? (
            ...
            <View style={homeStyles.emptyState}>
              ...
              <Text style={homeStyles.emptyTitle}>No reciped found</Text>
